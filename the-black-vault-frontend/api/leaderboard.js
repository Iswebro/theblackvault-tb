...
export default async function handler(req, res) {
  ...
  console.log("🟢 /api/leaderboard called", {
    method: req.method,
    url: process.env.REDIS_REST_URL ? "present" : "missing",
    token: process.env.REDIS_REST_TOKEN ? "present" : "missing",
  })
  ...
  try {
    // Fetch data from Redis, wrapping in try/catch for robust error handling
